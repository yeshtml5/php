<?php
    ...
    class Util {
         ...
         */
        static public function console($str, $mode = "log") {
            $str = str_replace('"', '\\"', $str);
            if ($mode == "log") {
        ...
        /**
         * Show all object or string
         * 사용법: <?= debug($sql); ?>
         */
        static public function debugger($var) {
            echo "<pre style='margin:20px auto;padding:20px;border:1px dashed #000; background:#dde8ee;font-size:12px;';>";
            print_r($var);
            echo "</pre>";
        }
